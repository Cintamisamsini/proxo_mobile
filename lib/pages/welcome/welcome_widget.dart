                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      60.0, 0.0, 60.0, 0.0),
                                              child: Text(
                                                'Ambil bagian dalam tantangan untuk berkontribusi pada kelestarian lingkungan.',
                                                textAlign: TextAlign.center,
                                                style:
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      60.0, 0.0, 60.0, 0.0),
                                              child: Text(
                                                'Tambahkan Sentuhan Ramah Lingkungan pada Rutinitas Anda!',
                                                textAlign: TextAlign.center,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .titleMedium
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    'Pantau statistik Anda dan lihat bagaimana tindakan harian Anda memberikan dampak',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      60.0, 0.0, 60.0, 0.0),
                                              child: Text(
                                                'Pantau dampak positif yang telah Anda lakukan untuk lingkungan.',
                                                textAlign: TextAlign.center,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .titleMedium
